...
namespace ManejoPresupuesto.Servicios
{
    ...
    {
        private readonly IRepositoriosUsuarios repositoriosUsuarios;

        public UsuarioStore(IRepositoriosUsuarios repositoriosUsuarios)
        {
            this.repositoriosUsuarios = repositoriosUsuarios;
        }
        public async Task<IdentityResult> CreateAsync(Usuario user, CancellationToken cancellationToken)
        {
            user.id = await repositoriosUsuarios.CrearUsuario(user);
        ...
        {
            return await repositoriosUsuarios.BuscarUsuarioPorEmail(normalizedEmail);
        }
        ...
        {
            return await repositoriosUsuarios.BuscarUsuarioPorEmail(normalizedUserName);
        }
