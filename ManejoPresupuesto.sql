USE [master]
GO
/****** Object:  Database [ManejoPresupuesto]    Script Date: 5/5/2022 12:44:32 PM ******/
...
GO
/****** Object:  Table [dbo].[Transacciones]    Script Date: 5/5/2022 12:44:32 PM ******/
SET ANSI_NULLS ON
GO
...
GO
INSERT [dbo].[Transacciones] ([Id], [UsuarioId], [FechaTransaccion], [Monto], [TipoTransaccionId], [Nota]) VALUES (1, N'Felipe                                                                                                                                                                                                                                                                                                                                                                                                                                                            ', CAST(N'2022-11-09T00:00:00.000' AS DateTime), CAST(1500.99 AS Decimal(18, 2)), 1, N'Esta es una transaccion de prueba                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       ')
GO
INSERT [dbo].[Transacciones] ([Id], [UsuarioId], [FechaTransaccion], [Monto], [TipoTransaccionId], [Nota]) VALUES (2, N'Felipe                                                                                                                                                                                                                                                                                                                                                                                                                                                            ', CAST(N'2022-05-05T00:00:00.000' AS DateTime), CAST(350.00 AS Decimal(18, 2)), 2, NULL)
GO
